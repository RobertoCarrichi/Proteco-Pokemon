...
public class Menu{
	...
	public void eleccionPokemon(Jugador jugador, boolean aleatoriamente) throws InterruptedException {
		try {
			...
			System.out.println("\tUPS! Has elegido alguna letra en un campo donde solo pueden ir numeros, tristemente volveras a empezar.");
		}	
	}
	...
	public int mostrarOpcionesTurno(){
		...
		try {
			...
			System.out.println("\tUPS! Has elegido alguna letra en un campo donde solo pueden ir numeros, intenta otra vez.");
		}
		return opcion;
	}
